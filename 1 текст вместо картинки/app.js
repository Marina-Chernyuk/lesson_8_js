...
function showMoreText(card) {
    ...
    let texts = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit, culpa libero debitis ullam soluta unde animi nulla? Modi voluptatibus magni eius eaque nostrum. Debitis unde fugit placeat perspiciatis sequi nulla!';
    
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML('afterend', `<div class="desc">${texts}</div>`);
